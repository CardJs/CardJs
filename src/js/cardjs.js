(function($) {
  ...
  var mailSvg = '<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"' +
    'x="0px" y="4px" width="24px" height="16px" viewBox="0 0 216 146" enable-background="new 0 0 216 146" xml:space="preserve">' +
  ...
  var informationSvg = '<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" ' +
    'x="0px" y="4px" width="24px" height="16px" viewBox="0 0 216 146" enable-background="new 0 0 216 146" xml:space="preserve">' +
  ...
  function setupCvcInput() {
    ...
    wrapper.append("<div class='icon'></div>");
    wrapper.find(".icon").append(lockSvg);
    wrapper.append("<div class='icon right popup'></div>");
    wrapper.find(".icon.right").append(informationSvg);
  }
